...
export default function ReportModal({
  ...
  return (
    <div className="absolute top-6 right-6 w-96 bg-white rounded-2xl shadow-2xl border border-slate-100 z-[1000] animate-in fade-in slide-in-from-right-8">
      ...
      <form onSubmit={handleSubmit(handleFormSubmit)} className="p-5 space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-sm h-24 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          {errors.description && (
